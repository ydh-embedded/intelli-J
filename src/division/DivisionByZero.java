...
public class DivisionByZero {
    ...
    // 1) java division.DivisionByZero löst ArrayIndexOutOfBoundsException aus (Failure)
    // 2) java division.DivisionByZero 10 xx löst eine NumberFormatException aus (Failure)
    // 3) java division.DivisionByZero 3 4 löst keine Exception aus, aber ein falsches Ergebnis (Failure).
    // 4) java division.DivisionByZero 3 0 löst eine ArithmeticException aus und stürzt ab (Failure).
}