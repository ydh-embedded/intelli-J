...
//        mProcessElementsIteration();
    ...
    public static void mAddAndRemoveElements() {
        ...
        //  das funktioniert, weil alle methoden die im List steht stehen auch ihm nachfahren arraylist
    ...
    public static void mSortNames() {

        List<Entry> entries = new ArrayList<>();
        entries.add(new Entry("Anton", "Müller", 20));
        entries.add(new Entry("Max", "Mustermann", 20));
        entries.add(new Entry("Jamee", "Auster", 20));

        System.out.println("sortierte Namensliste nach firstname /lastname/score: " + entries);

        entries.sort((first, second) -> second.score() - first.score());
        System.out.println("sortierte Namensliste nach scoreWert: " + entries);
